...
export class AuthController {
  ...
  @ApiOperation({ 
    ...
    description: 'Аутентифицирует пользователя через VK и возвращает JWT токен. Если пользователь не существует, создает нового с базовым стражем. Проверяет подпись VK для безопасности.'
  })
  @ApiBody({
    schema: {
      example: {
